...
export default function Sidenav({ children }) {
 ...
 const  [isCollapseSupplier,setIsCollapseSupplier]=React.useState(false)
  ...
  const  [isCollapseHistory,setIsCollapseHistory]=React.useState(false)
  ...
  const  [isCollapseSupplierProduct,setIsCollapseSupplierProduct]=React.useState(false)
 ...
 const router = useRouter()
  ...
  const handleCollapseCustomers=()=>{
   ...
   const handleCollapseHistory=()=>{
    setIsCollapseHistory(!isCollapseHistory)
   }
   ...
   const handleCollapseSupplierProduct=()=>{
    setIsCollapseSupplierProduct(!isCollapseSupplierProduct)
   }
...
onClick={()=>handleNavigation(text)}
  ...
  <List>
          ...
          <Collapse in={isCollapsePurchase} timeout="auto" unmountOnExit>
            {["all-purchase","daily-purchases-report"].map((text, index) => (
              <ListItem key={text} disablePadding sx={{ display: "block" }}>
                <ListItemButton
  ...
  <List>
          ...
          <Collapse in={isCollapseInvoice} timeout="auto" unmountOnExit>
            {["all-invoice","approval-invoice","print-invoice-list","invoice-list","invoice-list-pdf","daily-invoice-report"].map((text, index) => (
              <ListItem key={text} disablePadding sx={{ display: "block" }}>
                <ListItemButton
  ...
  <List>
          ...
          >
            ...
            >
              ...
              <ListItemText primary="Manage Payment History" sx={{ opacity: open ? 1 : 0 }} />
              {isCollapseHistory? <ExpandLessIcon /> : <ExpandMoreIcon />}

            </ListItemButton>
          </ListItem>
          <Collapse in={isCollapseHistory} timeout="auto" unmountOnExit>
  ...
  {/*start all  payment biling*/}

  <List>
          <ListItem
            disablePadding
            sx={{ display: "block" }}
            onClick={handleCollapseBilling}
          >
            <ListItemButton
              sx={{
                minHeight: 48,
            ...
            >
              ...
              <ListItemText primary="Manage Payment Billing" sx={{ opacity: open ? 1 : 0 }} />
        ...
        {/*end  all payment biling*/}

  {/*start all   stock report*/}
  ...
  <List>
          ...
          >
            ...
            >
              ...
              <ListItemText primary="Manage Stock Report" sx={{ opacity: open ? 1 : 0 }} />
  ...
  {/*start all   stock   get report supplier and product wise*/}

  <List>
          <ListItem
            disablePadding
            sx={{ display: "block" }}
            onClick={handleCollapseSupplierProduct}
          >
            <ListItemButton
              sx={{
                minHeight: 48,
            ...
            >
              ...
              <ListItemText primary="Manage Stock Report supp prod" sx={{ opacity: open ? 1 : 0 }} />
              {isCollapseSupplierProduct? <ExpandLessIcon /> : <ExpandMoreIcon />}

            </ListItemButton>
          </ListItem>
          <Collapse in={isCollapseSupplierProduct} timeout="auto" unmountOnExit>
            {["supplier-product-wise-report"].map((text, index) => (
              <ListItem key={text} disablePadding sx={{ display: "block" }}>
                <ListItemButton
        ...
        {/*end  all  stock     get report supplier and product wise*/}
